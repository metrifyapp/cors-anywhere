...
function proxyRequest(req, res, proxy, corsAnywhere) {
  ...
  req.url = corsAnywhere.proxyReqPathResolver ? corsAnywhere.proxyReqPathResolver(req) : location.path;
  ...
  if (corsAnywhere.proxyReqOptDecorator) {
    proxyOptions = corsAnywhere.proxyReqOptDecorator(proxyOptions, req);
  }
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    proxyReqPathResolver: null,
    proxyReqOptDecorator: null,
  };
